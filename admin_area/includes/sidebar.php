...
<nav class="navbar navbar-inverse navbar-fixed-top"><!-- navbar navbar-inverse navbar-fixed-top Begin -->
    <div class="navbar-header"><!-- navbar-header Begin -->
        ...
        <a href="https://www.e-acez.com/drayempire/index.php" class="navbar-brand" target="_blank"><small>View Store </small> </a>
    ...
    <div class="collapse navbar-collapse navbar-exl-collapse"><!-- collapse navbar-collapse navbar-exl-collapse Begin -->
        <ul class="nav navbar-nav side-nav"><!-- nav navbar-nav side-nav Begin -->
            ...
            <li  ><!-- list Begin -->
                <a href="#" data-toggle="collapse" data-target="#account"><!-- href Begin -->

                    <i class="fa fa-credit-card"></i> Bank Accounts
                    <i class="fa fa-fw fa-caret-down"></i> 

                </a><!-- href Finish -->

                <ul id="account" class="collapse"><!-- Begin Finish -->
                    <li>
                        <a href="index.php?edit_account"> Edit Bank Account </a>
                    </li>
                    <li>
                        <a href="index.php?view_account"> View Bank Account </a>
                    </li>
                </ul><!-- collapse Finish -->
